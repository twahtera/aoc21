...
/* package nixtest-0.1.0.0 */
#ifndef VERSION_nixtest
#define VERSION_nixtest "0.1.0.0"
#endif /* VERSION_nixtest */
#ifndef MIN_VERSION_nixtest
#define MIN_VERSION_nixtest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nixtest */
...
#define CURRENT_COMPONENT_ID "nixtest-0.1.0.0-inplace-nixtest"
